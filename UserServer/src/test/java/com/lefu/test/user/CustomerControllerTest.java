...
public class CustomerControllerTest extends WebAppContextSetupTest {
	...
	public void testCustomerShow() throws Exception {
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/customer/show/1.json"))
	...
	public void testCustomerAdd() throws Exception {
		MockHttpServletRequestBuilder post = MockMvcRequestBuilders.post("/customer/add.json");
